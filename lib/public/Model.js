...
import { QualityControlFlagsModel } from './views/QualityControlFlags/QualityControlFlagsModel.js';
...
export default class Model extends Observable {
    ...
    constructor(window, document) {
        ...
        this.qualityControlFlagsModel = new QualityControlFlagsModel(this);
        this.qualityControlFlagsModel.bubbleTo(this);
    ...
    async handleLocationChange() {
        ...
        switch (this.router.params.page) {
            ...
            case 'quality-control-flags':
                this.qualityControlFlagsModel.loadOverview(this.router.params);
                break;
            case 'quality-control-flag-create':
                this.qualityControlFlagsModel.loadCreation(this.router.params);
                break;
            case 'quality-control-flag-details':
                this.qualityControlFlagsModel.loadDetails(this.router.params);
                break;
            case 'run-detail':
