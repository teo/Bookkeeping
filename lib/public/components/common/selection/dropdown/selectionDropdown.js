 ...
 * @param {Observable} openingObservable observable notified when the options list is openened
...
export const selectionDropdown = (selectionDropdownModel, configuration) => {
    ...
    return dropdown(
        ...
        dropdownOptions(selectionDropdownModel, selectorPrefix, displayOption, openingObservable),
        {
            selectorPrefix,
