...
import { QualityControlFlagsOverviewPage } from './views/QualityControlFlags/Overview/QualityControlFlagsOverviewPage.js';
import { LogReplyPage } from './views/Logs/Create/LogReplyPage.js';
import { QualityControlFlagCreationPage } from './views/QualityControlFlags/Creation/QualityControlFlagCreationPanel.js';
import { QualityControlFlagDetailPage } from './views/QualityControlFlags/details/QualityControlFlagDetailsPanel.js';
...
export default (model) => {
    const pages = {
        ...
        'quality-control-flags': QualityControlFlagsOverviewPage,
        'quality-control-flag-create': QualityControlFlagCreationPage,

        'quality-control-flag-details': QualityControlFlagDetailPage,
