...
import { amountFilter } from '../../../components/Filters/common/filters/amountFilter.js';
...
export const runsActiveColumns = {
    ...
    tags: {
        ...
        filterProfiles: ['runsPerDataPass'],
    },
    fillNumber: {
        name: 'Fill No.',
        visible: true,
    ...
    aliceL3Current: {
        ...
        filter: (runModel) => amountFilter(
            runModel.aliceL3CurrentFilter,
            (value) => {
                runModel.aliceL3CurrentFilter = value;
            },
            {
                operatorAttributes: {
                    id: 'aliceL3Current-operator',
                },
                limitAttributes: {
                    id: 'aliceL3Current-limit',
                },
            },
        )
    },
