...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    constructor(model) {
        ...
        this._o2StartFilterModel = new TimeRangeInputModel();
        this._o2StartFilterModel.observe(() => this._applyFilters());
        this._o2StartFilterModel.visualChange$.bubbleTo(this);

        this._o2StopFilterModel = new TimeRangeInputModel();
        this._o2StopFilterModel.observe(() => this._applyFilters());
        this._o2StopFilterModel.visualChange$.bubbleTo(this);
    ...
    /**
     * Returns the model for o2 start filter
     *
     * @return {TimeRangeInputModel} the filter model
     */
    get o2StartFilterModel() {
        return this._o2StartFilterModel;
    }

    /**
     * Returns the model for o2 stop filter
     *
     * @return {TimeRangeInputModel} the filter model
     */
    get o2stopFilterModel() {
    ...
    _getFilterQueryParams() {
        return {
            ...
            ...!this._o2StartFilterModel.isEmpty && {
                'filter[o2start][from]': this._o2StartFilterModel.normalized.from,
                'filter[o2start][to]': this._o2StartFilterModel.normalized.to,
            },
            ...!this._o2StopFilterModel.isEmpty && {
                'filter[o2end][from]': this._o2StopFilterModel.normalized.from,
                'filter[o2end][to]': this._o2StopFilterModel.normalized.to,
            },
