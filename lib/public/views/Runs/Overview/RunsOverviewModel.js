...
export class RunsOverviewModel extends OverviewPageModel {
    ...
    reset(fetch = true) {
        ...
        this._aliceL3CurrentFilter = null;
    ...
    getActiveFilters() {
        ...
        if (this._aliceL3CurrentFilter !== null) {
            this.activeFilters.push('Alice L3 current');
        }
    ...
    /**
     * Returns the run Alice L3 current filter
     * @return {{operator: string, limit: (number|null)}|null} L3 current filter
     */
    get aliceL3CurrentFilter() {
        return this._aliceL3CurrentFilter;
    }

    /**
     * Sets the Alice L3 current filter
     *
     * @param {{operator: string, limit: (number|null)}|null} newAliceL3CurrentFilter new filter value
     *
     * @return {void}
     */
    set aliceL3CurrentFilter(newAliceL3CurrentFilter) {
        this._aliceL3CurrentFilter = newAliceL3CurrentFilter;
        this._applyFilters();
    }
