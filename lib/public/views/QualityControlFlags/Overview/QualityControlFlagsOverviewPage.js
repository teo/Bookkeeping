 ...
 */
export const QualityControlFlagsOverviewPage = (model) => {
    const { qualityControlFlagsModel: { overviewModel: qualityControlFlagsOverviewModel } } = model;
    ...
    return h('', {
        ...
        h('.w-100.flex-column', [
            ...
            table(
                ...
                {
                    callback: (entry) => ({
                        onclick: () => model.router.go(`?page=quality-control-flag-details&flagId=${entry.id}`),
                    }),
                    classes: '.clickable.table-sm',
                },
                null,
                null,
            ),
