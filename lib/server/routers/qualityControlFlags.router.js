...
exports.qualityControlFlagsRouter = {
    ...
    children: [
        ...
        },
        {
            method: 'post',
            path: '/verify',
            controller: QualityControlFlagsController.createQualityControlFlagVerificationHandler,
        },
        {
            method: 'get',
        ...
        },
        {
            method: 'delete',
            path: '/:flagId',
            controller: QualityControlFlagsController.deleteQualityControlFlagHandler,
        },
    ],
};
