...
const getLhcFillStatisticsHandler = async (request, response) => {
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getLhcFillStatistics({
...
const getWeeklyRunDataSizeHandler = async (request, response) => {
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getWeeklyDataSize({
                from: requestDto.query.from,
                to: requestDto.query.to,
            });
            response.status(200).json({ data });
...
const getTimeBetweenRunsDistributionHandler = async (request, response) => {
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getTimeBetweenRunsDistribution({
                from: requestDto.query.from,
                to: requestDto.query.to,
            });
            response.status(200).json({ data });
...
const getDetectorEfficiencyPerFillHandler = async (request, response) => {
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getDetectorsEfficienciesPerFill({
                from: requestDto.query.from,
                to: requestDto.query.to,
            });
            response.status(200).json({ data });
...
const getTagsOccurrencesInLogsHandler = async (request, response) => {
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getTagsOccurrencesInLogs({
                from: requestDto.query.from,
                to: requestDto.query.to,
            });
            response.status(200).json({ data });
...
/**
 * Route to get the EoR reasons occurrences in runs
 */
const getEorReasonsOccurrencesHandler = async (request, response) => {
    const requestDto = await dtoValidator(DtoFactory.queryOnly({
        from: Joi.date().required(),
        to: Joi.date().required(),
    }), request, response);
    ...
    if (requestDto) {
        try {
            const data = await statisticsService.getEorReasonsOccurrences({
                from: requestDto.query.from,
                to: requestDto.query.to,
            });
            response.status(200).json({ data });
